...
with (thisform)
{
	...
	if ((p0.checked == false) && (p1.checked == false) && (p2.checked == false) && (p3.checked == false) && (p4.checked == false) && (p5.checked == false) && (p6.checked == false) && (p7.checked == false) && (p8.checked == false) && (p9.checked == false) && (p10.checked == false))
...
//mm		require_once('sh_includes/Mail/mail.php');
		...
		$ccList = "";
		if (isset($_POST['p0'])) { $ccList .= "RCook@artegan.com "; }
		...
		if (isset($_POST['p9'])) { $ccList .= "skagitvalley@artegan.com "; }
		if (isset($_POST['p10'])) { $ccList .= "dallasranch@artegan.com "; }

		$ccList = str_replace(" ", ", ", trim($ccList));
//mm		echo "<br>ccList: " .$ccList;
//mm		$em_to = $ccList;

//mm		$headers = array('To' => $ccList, 'From' => EMAIL_FROM, 'Cc' => " rcook@artegan.com", 'Subject' => EMAIL_SUBJECT, 'X-Mailer' => 'PHP 4.x');
//mm		$headers = array('To' => $ccList, 'From' => EMAIL_FROM, 'Cc' => "  amylehrman@gmail.com, rcook@artegan.com", 'Subject' => EMAIL_SUBJECT, 'X-Mailer' => 'PHP 5.x');
...
<span style="font-size: .85em;">
                ...
                <input type="checkbox" name="p9" id="p9" value="Skagit Valley Senior Village, Burlington, WA"/>Burlington, WA: Skagit Valley Senior Village<br>
                <input type="checkbox" name="p10" id="p10" value="The Commons at Dallas Ranch, Antioch, CA"/>Antioch, CA: The Commons at Dallas Ranch<br>
