...
//mm		require_once('sh_includes/Mail/mail.php');
		...
		if (isset($_POST['p9'])) { $ccList .= "lwarren@artegan.com"; }

		$ccList = str_replace(" ", ", ", trim($ccList));
//mm		echo "<br>ccList: " .$ccList;
//mm		$em_to = $ccList;

//mm		$headers = array('To' => $ccList, 'From' => EMAIL_FROM, 'Cc' => "shaines@artegan.com,  amylehrman@gmail.com, rcook@artegan.com", 'Subject' => EMAIL_SUBJECT, 'X-Mailer' => 'PHP 4.x');
//mm		$headers = array('To' => $ccList, 'From' => EMAIL_FROM, 'Cc' => "shaines@artegan.com,  amylehrman@gmail.com, rcook@artegan.com", 'Subject' => EMAIL_SUBJECT, 'X-Mailer' => 'PHP 5.x');
...
//mm		$em_cc = "Cc: shaines@artegan.com,  amylehrman@gmail.com, rcook@artegan.com";
