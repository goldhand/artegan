...
/*
		...
		$time = $this->getRealDateTime();
		$this->em_msg .= "\n\n" .$time;
		echo "<br>To: " .$this->em_to. "<br>Subj: " .$this->em_subj. "<br>Subj: " .$this->em_msg. "<br>";
		echo "<br>em_header: " .$this->em_header. "<br>";
 */


		$result = 0;
//		If ($result = mail($this->em_to, $this->em_subj, $this->em_msg, $this->em_header)) {
//		If ($result = mail($this->$header, $this->msg)) {
//		If ($result = mail($header, $msg)) {
//		If ($result = mail($em_to, $msg, $header)) {
		$parms = "";
