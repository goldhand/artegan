...
<a href="http://www.artegan.com/contact.php"><img src="http://www.artegan.com/images/contact.png" alt="Contact Us Today! (Click Here)" title="Contact Us Today! (Click Here)" style="border:none"></a>
</div>
<br>
				...
				<?php writeNavLinkA("Locations", "/communities/locations/index.php");?>
					...
					<ul class="third-ul">
						...
						switch ($_SERVER['SCRIPT_NAME']) 
						{
							...
							case "/communities/locations/burlington/menu.php":
							...
							case "/communities/locations/antioch/menu.php":						
						...
						writeNavLink("Portland, OR", "/communities/locations/portland/index.php");
