...
<!--Masthead-->
	<?php include("../../../sh_includes/masthead-maple-valley.php");?>
...
<!--Top image-->
				...
				<img class="L-photo" src="images/maple-valley-L.jpg">
				<img class="R-photo" src="images/maple-valley-R.jpg">
			<div id="main_nav">
...
<!--Community Left Menu-->
	<?php include("../maple-valley_menu.php") ?>
...
<!--Request Form table1 -->
	<?php include("../request-form-table1.php") ?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property5" id="property5" value="fountaincourt@artegan.com " CHECKED /> Fountain Court (Maple Valley, WA)<br>
				...
				<h2>Cottages / Independent Living</h2>
					<input type="checkbox" name="property1" id="property1" value="fountaincourt@artegan.com " CHECKED /> Fountain Court (Maple Valley, WA)<br>
