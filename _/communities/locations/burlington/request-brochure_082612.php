...
<!--Request Form table1 -->	
	<?php include("../request-form-table1.php") ;?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property12" id="property12" value="lwarren@artegan.com" CHECKED /> Skagit Valley Senior Village (Burlington, WA)<br>
				...
				<h2>Cottages / Independent Living</h2>
					...
					<input type="checkbox" name="property12" id="property13" value="lwarren@artegan.com" CHECKED /> Skagit Valley Senior Village (Burlington, WA)<br>					
