...
<!--Request Form table1 -->
	<?php include("../request-form-table1.php") ?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property14" id="property14" value="dallasranch@artegan.com " CHECKED /> The Commons (Antioch, CA)<br>
				...
				<h2>Cottages / Independent Living</h2>
					...
					<input type="checkbox" name="property16" id="property16" value="dallasranch@artegan.com " CHECKED /> The Commons (Antioch, CA)<br>
				...
				<h2>Memory Care</h2>
					...
					<input type="checkbox" name="property18" id="property18" value="dallasranch@artegan.com " CHECKED /> The Commons (Antioch, CA)<br>
