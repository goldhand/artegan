...
<!--Request Form table1 -->
	<?php include("../request-form-table1.php") ?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property10" id="property10" value="laurelparc@artegan.com " CHECKED /> Laurel Parc (Portland NW, OR)<br>
				...
				<h2>Cottages / Independent Living</h2>
					...
					<input type="checkbox" name="property11" id="property11" value="laurelparc@artegan.com " CHECKED /> Laurel Parc (Portland NW, OR)<br>
