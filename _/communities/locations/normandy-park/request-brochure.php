...
<!--Request Form table1 -->
	<?php include("../request-form-table1.php") ?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property7" id="property7" value="normandypark@artegan.com " CHECKED /> Normandy Park (Normandy Park, WA)<br>
				...
				<h2>Memory Care</h2>
					<input type="checkbox" name="property2" id="property2" value="normandypark@artegan.com " CHECKED  /> Normandy Park (Normandy Park, WA)<i>coming soon</i><br>
