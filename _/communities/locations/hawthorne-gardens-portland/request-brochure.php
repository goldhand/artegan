...
//mm		$headers = array('To' => $recList, 'CC' => EMAIL_CC, 'From' => EMAIL_FROM, 'Subject' => EMAIL_SUBJECT, 'X-Mailer' => 'PHP 4.x');
...
<!--Request Form table1 -->
	<?php include("../request-form-table1.php") ;?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property9" id="property9" value="hawthornegardens@artegan.com " CHECKED /> Hawthorne Gardens (Portland SE, OR)<br>


					<input type="checkbox" name="property10" id="property10" value="laurelparc@artegan.com " /> Laurel Parc (Portland NW, OR)<br>
					
					<input type="checkbox" name="property13" id="property13" value="skagitvalley@artegan.com "  /> Skagit Valley (Burlington, WA)<br>
				...
				<h2>Cottages / Independent Living</h2>
					...
					<input type="checkbox" name="property15" id="property15" value="skagitvalley@artegan.com "  /> Skagit Valley (Burlington, WA)<br>
				...
				<h2>Memory Care</h2>
					...
					<input type="checkbox" name="property12" id="property12" value="hawthornegardens@artegan.com " CHECKED /> Hawthorne Gardens (Portland SE, OR)<br>
					
					<input type="checkbox" name="property17" id="property17" value="skagitvalley@artegan.com "  /> Skagit Valley (Burlington, WA)<br>
