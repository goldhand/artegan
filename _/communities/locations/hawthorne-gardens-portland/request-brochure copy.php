...
if ($blnSubmitted) {
	...
	if ($theForm->isValid()) {
		...
		//loop over checkboxes 1-13, grabbing the email addresses for the checked boxes
		$n = 1;
		while ($n <= 13) {
...
<!--Request Form table1 -->	
	<?php include("../request-form-table1.php") ;?>
				...
				<h2>Assisted Living</h2>
					...
					<input type="checkbox" name="property3" id="property3" value="kharris@artegan.com" CHECKED /> Apple Springs (Omak, WA)<br>
					
					<input type="checkbox" name="property4" id="property4" value="aram@artegan.com" /> Columbia Ridge (Washougal, WA)<br>
					
					<input type="checkbox" name="property5" id="property5" value="CStarchman@artegan.com, jgatlin@artegan.com" /> Fountain Court (Maple Valley, WA)<br>
				
					<input type="checkbox" name="property6" id="property6" value="kcrabtree@artegan.com, mdecicio@artegan.com, bfaught@artegan.com, kszalay@artegan.com" /> Maple Glen (Shelton, WA)<br>
					
					<input type="checkbox" name="property7" id="property7" value="kparks@artegan.com, psmith@artegan.com" /> Normandy Park (Normandy Park, WA)<br>
					
					<input type="checkbox" name="property8" id="property8" value="mwear@artegan.com" /> Parkview (Colville, WA)<br>
					
							
					
					<input type="checkbox" name="property10" id="property10" value="jeanna@laurelparc.com" /> Laurel Parc (Portland, OR)<br>
								
				<br>
				<h2>Cottages / Independent Living</h2>
					<input type="checkbox" name="property1" id="property1" value="CStarchman@artegan.com, jgatlin@artegan.com" /> Fountain Court (Maple Valley, WA)<br>
					<input type="checkbox" name="property11" id="property10" value="jeanna@laurelparc.com" /> Laurel Parc (Portland, OR)<br><br>
					
										
					
					
				<h2>Memory Care</h2>
					<input type="checkbox" name="property2" id="property2" value="kparks@artegan.com, psmith@artegan.com"  /> Normandy Park (Normandy Park, WA) <i>coming soon</i><br>
